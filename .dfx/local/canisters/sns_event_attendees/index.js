...
import { idlFactory } from './sns_event_attendees.did.js';
export { idlFactory } from './sns_event_attendees.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.SNS_EVENT_ATTENDEES_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./sns_event_attendees.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the sns_event_attendees canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./sns_event_attendees.did.js")._SERVICE>}
 */
export const sns_event_attendees = createActor(canisterId);
