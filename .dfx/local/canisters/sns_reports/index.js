...
import { idlFactory } from './sns_reports.did.js';
export { idlFactory } from './sns_reports.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.SNS_REPORTS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./sns_reports.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the sns_reports canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./sns_reports.did.js")._SERVICE>}
 */
export const sns_reports = createActor(canisterId);
