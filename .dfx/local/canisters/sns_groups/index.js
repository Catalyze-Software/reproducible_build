...
import { idlFactory } from './sns_groups.did.js';
export { idlFactory } from './sns_groups.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.SNS_GROUPS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./sns_groups.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the sns_groups canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./sns_groups.did.js")._SERVICE>}
 */
export const sns_groups = createActor(canisterId);
