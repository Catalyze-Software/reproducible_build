...
import { idlFactory } from './sns_members.did.js';
export { idlFactory } from './sns_members.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.SNS_MEMBERS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./sns_members.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the sns_members canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./sns_members.did.js")._SERVICE>}
 */
export const sns_members = createActor(canisterId);
