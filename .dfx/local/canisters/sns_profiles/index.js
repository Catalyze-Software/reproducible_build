...
import { idlFactory } from './sns_profiles.did.js';
export { idlFactory } from './sns_profiles.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.SNS_PROFILES_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./sns_profiles.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the sns_profiles canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./sns_profiles.did.js")._SERVICE>}
 */
export const sns_profiles = createActor(canisterId);
