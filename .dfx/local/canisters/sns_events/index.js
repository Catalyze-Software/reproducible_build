...
import { idlFactory } from './sns_events.did.js';
export { idlFactory } from './sns_events.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.SNS_EVENTS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./sns_events.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the sns_events canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./sns_events.did.js")._SERVICE>}
 */
export const sns_events = createActor(canisterId);
